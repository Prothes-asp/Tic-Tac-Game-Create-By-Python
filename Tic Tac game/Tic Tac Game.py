...
def CheckWinner():
    ...
    if winner ==1:
        messagebox.showinfo(title="Congratulations!",
            message="\"Asp Prothes\" is the winner")
    elif winner ==2:
        messagebox.showinfo(title="Congratulations!",
            message="\"Sm Sherayase\" is the winner")
    elif mov ==9:
        messagebox.showinfo(title="Draw",
            message="Opps! Match Draw!")
